/**
 * @fileoverview Script to re-upsert the Imoprime knowledge base to Pinecone.
 * This script directly uses the ingestion-service to process documents.
 * @filelocation packages/backend/scripts/re-upsert-imoprime-knowledge-base.js
 * @description This script automates the re-ingestion of Imoprime knowledge base documents into the Pinecone vector database. It's useful for updating or refreshing the knowledge base.
 * @why This script exists to provide a direct, programmatic way to re-upsert Imoprime documents, bypassing the API for specific administrative tasks.
 * @relevant_files packages/backend/src/services/ingestion-service-imoprime.js, imoprime knowledge base, packages/backend/.env
 */
...
const TEST_DATA_DIR = path.join(__dirname, '..', '..', '..', 'imoprime knowledge base');
